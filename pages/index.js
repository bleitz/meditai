    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <div style={{ "margin": "16px 0 48px", "display": "flex", "flexDirection": "column", "alignItems": "center" }}>
          ...
          <Text h2>Your personal meditation guide.</Text>
          <Text>Whether you want to cultivate a specific feeling or internalize a thought, I am here to help. Simply let me know what you're looking for, and I'll guide you through your meditation.</Text>
          ...
          <div>
            ...
            >
              ...
              <Modal.Body>
                ...
                <Text>This is a little tool that automatically creates a personalized, guided meditation. Use it to explore specific thoughts and feelings, for guidance or to bring more intent to your everyday life.</Text>
                ...
                <Text>The script is genererated by OpenAI's GPT API. The audio is generated by Azure's Text-to-Speech API. Music by Andrewkn. Loading animation by Wan Souza.</Text>
                ...
                <Text>And here technology can lend us a hand: ChatGPT is able to generate surprisingly gentle, visual and specific scripts. And todays Text-to-Speech technology makes the scripts come to life.</Text>
              </Modal.Body>
